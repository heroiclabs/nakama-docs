...
| c | Receives [realtime match](../concepts/client-relayed-multiplayer.md) messages. |
| d | Receives events when the [matchmaker](../concepts/matches.md) has found match participants. |
| e | Receives join or leave events within [realtime multiplayer](../concepts/client-relayed-multiplayer.md) |
| f | Receives live [in-app notifications](../concepts/in-app-notifications.md) sent from the server. |
| g | Receives [realtime chat](../concepts/realtime-chat.md) messages sent by other users. |
| h | Receives join and leave events within [chat](../concepts/realtime-chat.md). |
-->

...
!!! Bug "Help and contribute"
    The C++ client is [open source](https://github.com/heroiclabs/nakama-cpp) on GitHub. Please report issues and contribute code to help us improve it.
...
| onMatchPresence | Received join and leave events within [realtime multiplayer](../concepts/client-relayed-multiplayer.md). |

...
![Fish Game GameManager object](images/tutorials/fish-game-unity/game-manager.png)
...
![Fish Game NetworkLocalPlayer object](images/tutorials/fish-game-unity/network-localplayer.png)
